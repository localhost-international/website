<template>
  <div id="main">
    <nav>
      <h1>localhost&nbsp;<span aria-hidden="true">🌐</span></h1>
      ...
      <p>Currently crafting lab <router-link to="/experiments">experiments</router-link> and decentralised web <router-link to="/projects">projects</router-link>.</p><br />
